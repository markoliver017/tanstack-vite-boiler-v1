...
interface CinemaFormattedListProps {
    cinemaId: number;
}

export function CinemaFormattedList({ cinemaId }: CinemaFormattedListProps) {
    const [isDialogOpen, setIsDialogOpen] = useState(false);

    const { data, refetch } = useQuery(cinemaFormatMapListOptions(cinemaId));
