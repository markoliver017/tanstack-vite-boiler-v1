...
export function CreateCheckerAssignmentForm({
    ...
    const createMutation = useCreateCheckerAssignment();
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Slot No (Optional)</FormLabel>
                            <FormControl>
                                <Input
                                    type="number"
                                    min={1}
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            >
                                <FormControl>
                                    <SelectTrigger>
                                        <SelectValue placeholder="All cinemas in theater" />
                                    </SelectTrigger>
                                </FormControl>
                                <SelectContent>
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            >
                                <FormControl>
                                    <SelectTrigger>
                                        <SelectValue placeholder="Select cinema format" />
                                    </SelectTrigger>
                                </FormControl>
                                <SelectContent>
                                    <SelectItem value="none">Unset (planning stage)</SelectItem>
                ...
                <Button type="submit" variant="success" disabled={createMutation.isPending}>
                    {createMutation.isPending ? "Saving..." : "Create Slot"}
                </Button>
            </form>
        </Form>
    );
